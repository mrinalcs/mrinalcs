...
This post is to show Markdown syntax rendering on [**Link**](https://mrinal.ga/), you can also use it as an example of writing. Now, let's start looking at text and typography.
...
![Desktop View](/images/copyright-free-images-750x420.jpg){: width="972" height="589" .w-75 .normal}
